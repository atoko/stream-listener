...
export const TWITCH_ENVIRONMENT = {
  ...
  TWITCH_EVENTSUB_KEEPALIVE_TIMEOUT_SECONDS:
    Number(env.TWITCH_EVENTSUB_KEEPALIVE_TIMEOUT_SECONDS) || 60,
  TWITCH_EVENTSUB_WEBSOCKET_URL: `wss://eventsub.wss.twitch.tv/ws?keepalive_timeout_seconds=${env.TWITCH_EVENTSUB_KEEPALIVE_TIMEOUT_SECONDS || 60}`,
