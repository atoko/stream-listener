...
export type Message =
  | MessageBase<
      "session_welcome",
      MetadataBase,
      { session: SessionBase<"connected"> }
    >
  | MessageBase<
      "session_reconnect",
      MetadataBase,
      { session: SessionBase<"reconnecting"> }
    >
  | MessageBase<
      "notification",
      MetadataNotificationMessage,
      { subscription: Subscription; event: RewardRedeemEvent }
    >
...
export interface RewardRedeemEvent
  extends SubscriptionBase<"channel.channel_points_custom_reward_redemption.add"> {
