...
import { type DictParsedTags, parseTags } from "./tags.mjs";
import { type ParsedSource, parseSource } from "./source.mjs";
import { type ParsedCommand, parseParameters } from "./parameters.mjs";
 ...
 * @param message
 */
export function parseIrcMessage(message: string): ParsedMessage {
